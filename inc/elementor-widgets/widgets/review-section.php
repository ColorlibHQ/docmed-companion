...
/**
 *
 * Docmed Review Contents section widget.
 *
 * @since 1.0
 */
class Docmed_Review_Contents extends Widget_Base {

	public function get_name() {
		return 'docmed-review-contents';
	}

	public function get_title() {
		return __( 'Review Contents', 'docmed-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'reviews_content',
			[
				'label' => __( 'Review Contents', 'docmed-companion' ),
			]
        );
		$this->add_control(
            'reviews', [
                ...
                'fields' => [
                    [
                        'name' => 'review_bg_img',
                        'label' => __( 'Review BG Image', 'docmed-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'review_txt',
                        'label' => __( 'Review Text', 'docmed-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'reviewer_name',
                        'label' => __( 'Reviewer Name', 'docmed-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Asana Korim', 'docmed-companion' ),
                    ],
                ],
                'default'   => [
                    [
                        ...
                        'reviewer_name'         => __( 'Asana Korim', 'docmed-companion' ),
                    ],
                    [
                        'review_bg_img'           => [
                            'url'               => Utils::get_placeholder_image_src(),
                        ...
                        'review_txt'            => 'Donec imperdiet congue orci consequat mattis. Donec rutrum porttitor <br>sollicitudin. Pellentesque id dolor tempor sapien feugiat ultrices nec sed neque.<br>Fusce ac mattis nulla. Morbi eget ornare dui.',
                        'reviewer_name'         => __( 'Mithila', 'docmed-companion' ),
                    ],
                ]
            ]
        );
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Review Section', 'docmed-companion' ),
        ...
        $this->add_control(
            'sec_overlay_col', [
                'label' => __( 'Section Overlay Color', 'docmed-companion' ),
        ...
        <div class="testmonial_active owl-carousel">
            ...
            if( is_array( $reviews ) && count( $reviews ) > 0 ){
                foreach ( $reviews as $review ) {
                    $review_bg_img = !empty( $review['review_bg_img']['url'] ) ? $review['review_bg_img']['url'] : '';
                    $reviewer_name = !empty( $review['reviewer_name'] ) ? $review['reviewer_name'] : '';
                    $review_txt    = !empty( $review['review_txt'] ) ? $review['review_txt'] : '';
                    ?>
                    <div class="single-testmonial overlay2" <?php echo docmed_inline_bg_img( esc_url( $review_bg_img ) ); ?>>
                        <div class="container">
                            <div class="row">
