...
/**
 *
 * Docmed elementor faq section section widget.
 *
 * @since 1.0
 */
class Docmed_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'docmed-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'docmed-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'docmed-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Frequently Ask Question', 'docmed-companion' )
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'docmed-companion' ),
		...
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'docmed-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'docmed-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
     ...
     */
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Inner Styles', 'docmed-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Item Icon Color', 'docmed-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_title_col', [
                'label' => __( 'Item Title Color', 'docmed-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_text_col', [
                'label' => __( 'Item Text Color', 'docmed-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $info_icon = DOCMED_DIR_IMGS_URI . 'info-icon.png';
    ?>
