...
----------------------------------------*/
class docmed_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('docmed_instagram_photo',esc_html__('[ Docmed ] Intagram Photo','docmed-companion'),array(
			'description' => esc_html__('Docmed Instagram Photo Widget','docmed-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'docmed-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'docmed-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'docmed-companion'); ?></label>
...
if(!function_exists('docmed_instagram_widgets')):
	function docmed_instagram_widgets(){
		register_widget('docmed_instagram_photo');
	}
	add_action('widgets_init','docmed_instagram_widgets');
endif;
