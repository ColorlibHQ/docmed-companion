...
class Docmed_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Docmed ] Social Links', 'docmed-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'docmed-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'docmed-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'docmed-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'docmed-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'docmed-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'docmed-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'docmed-companion'); ?></label>
...
} // Class docmed_social_links ends here


// Register and load the widget
function docmed_social_links_widget_load() {
	register_widget( 'Docmed_social_links' );
}
add_action( 'widgets_init', 'docmed_social_links_widget_load' );